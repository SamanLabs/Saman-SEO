...
Do NOT include seller (not standard for AggregateOffer).
  ...
  <verify>Run: `grep -n "build_aggregate_offer" includes/Schema/Types/class-product-schema.php` confirms method exists. Run: `grep "lowPrice\|highPrice\|child_is_in_stock" includes/Schema/Types/class-product-schema.php` confirms all required properties.</verify>
