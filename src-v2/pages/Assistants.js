					...
					<div className="panel">
						...
						<div className="form-row">
							...
							<p className="form-help">
								Define the assistant's personality and
								expertise.
							</p>
						</div>
						<div className="form-row">
						...
						<div className="form-row">
							...
							/>
							<p className="form-help">
								Use custom_ID for custom models (e.g.,
								custom_1).
							</p>
						</div>
				...
				<div className="assistants-notice">
					...
					<div className="assistants-notice__content">
						...
						{ aiPilot?.installed ? (
							<>
								<p>
									WP AI Pilot is installed but needs
									configuration. Add an API key to enable AI
									assistants.
								</p>
								<a
									href={
							...
							<>
								<p>
									Install WP AI Pilot to access AI-powered
									assistants for SEO optimization, content
									generation, and more.
								</p>
								<a
							...
							>
								...
								>
									...
									<div className="assistant-card__content">
										...
										{ assistant.usage > 0 && (
											<span className="assistant-card__usage">
												{ assistant.usage } messages
											</span>
										) }
									</div>
								</button>
