		...
		<div className="saman-seo-analysis">
			{ visibleCategories.map( ( category ) => {
				...
				return (
					<div
						key={ category.key }
						className="saman-seo-analysis__category"
					>
						<div
							className={ `saman-seo-analysis__header saman-seo-analysis__header--${ status }` }
						>
...
const MetricItem = ( { metric } ) => {
	...
	return (
		...
		>
			<span
				className={ `saman-seo-analysis__status saman-seo-analysis__status--${ statusClass }` }
			>
				{ StatusIcons[ statusClass ] }
			</span>
			<div className="saman-seo-analysis__content">
				<span className="saman-seo-analysis__label">
					{ metric.label }
				</span>
				{ metric.status && (
					<span className="saman-seo-analysis__detail">
						{ metric.status }
					</span>
				) }
			</div>
