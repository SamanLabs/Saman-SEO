		...
		>
			{ label && (
				<div className="saman-seo-template-input__header">
					...
					{ maxLength && (
						<span
							className={ `saman-seo-template-input__counter ${
								isOverLimit
									? 'over-limit'
									: charCount > 0
									? 'has-value'
			...
			<div className="saman-seo-template-input__container">
				...
				<div
					ref={ highlightRef }
					className={ `saman-seo-template-input__highlight ${
						multiline ? 'multiline' : ''
					}` }
					aria-hidden="true"
				>
					{ renderHighlighted.map( ( part, index ) =>
						part.type === 'variable' ? (
							...
							>
								<span className="saman-seo-template-input__bracket">
									{ '{' }
								</span>
								<span className="saman-seo-template-input__bracket">
									{ '{' }
								</span>
								<span className="saman-seo-template-input__tag">
									{ part.fullTag }
								</span>
								<span className="saman-seo-template-input__bracket">
									{ '}' }
