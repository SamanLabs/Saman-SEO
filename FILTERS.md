...
**Example:**
```php
add_filter( 'saman_seo_description', function( $desc, $post ) {
...
**Example:**
```php
add_filter( 'saman_seo_robots_array', function( $robots ) {
...
add_filter( 'saman_seo_og_description', function( $desc, $post ) {
    if ( is_singular( 'product' ) ) {
...
// Override OG type
add_filter( 'saman_seo_og_type', function( $type, $post ) {
    if ( is_singular( 'event' ) ) {
        return 'event';
    }
    if ( is_singular( 'product' ) ) {
...
**Example:**
```php
add_filter( 'saman_seo_schema_webpage', function( $data ) {
...
**Example:**
```php
add_filter( 'saman_seo_schema_article', function( $data ) {
    $post = get_queried_object();
...
**Example:**
```php
add_filter( 'saman_seo_sitemap_max_urls', function( $max ) {
...
**Example:**
```php
add_filter( 'saman_seo_sitemap_excluded_terms', function( $excluded ) {
...
**Example:**
```php
add_filter( 'saman_seo_social_tags', function( $tags ) {
...
**Example:**
```php
add_filter( 'saman_seo_social_multi_tags', function( $multi_tags ) {
...
add_filter( 'saman_seo_title', 'my_early_title_mod', 5, 2 );

// Run after most other filters
add_filter( 'saman_seo_title', 'my_final_title_mod', 50, 2 );
```
