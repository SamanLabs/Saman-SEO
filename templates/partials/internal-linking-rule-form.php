...
$form_heading     = $is_edit ? __( 'Edit rule', 'wp-seo-pilot' ) : __( 'Add rule', 'wp-seo-pilot' );
...
<div class="wpseopilot-card wpseopilot-links__rule">
	<header class="wpseopilot-links__rule-hero">
		<div>
			<p class="wpseopilot-links__pill"><?php esc_html_e( 'Internal Linking', 'wp-seo-pilot' ); ?></p>
			<h2><?php echo esc_html( $form_heading ); ?></h2>
			<p><?php esc_html_e( 'Build automated linking playbooks with rich targeting, controls, and live previews.', 'wp-seo-pilot' ); ?></p>
			<ul>
				<li><?php esc_html_e( 'Keyword-driven replacements with per-rule priorities.', 'wp-seo-pilot' ); ?></li>
				<li><?php esc_html_e( 'Category + UTM inheritance keeps tracking consistent.', 'wp-seo-pilot' ); ?></li>
				<li><?php esc_html_e( 'Placement + scope controls prevent overlinking.', 'wp-seo-pilot' ); ?></li>
			</ul>
		</div>
		<div class="wpseopilot-links__rule-hero-meta">
			<div>
				<span><?php esc_html_e( 'Avg. links saved', 'wp-seo-pilot' ); ?></span>
				<strong>12 / post</strong>
			</div>
			<div>
				<span><?php esc_html_e( 'Rules running', 'wp-seo-pilot' ); ?></span>
				<strong><?php echo esc_html( number_format_i18n( max( 1, count( $all_rules ) ) ) ); ?></strong>
			</div>
			<a href="<?php echo esc_url( add_query_arg( [ 'tab' => 'rules' ], $page_url ) ); ?>" class="button button-secondary" aria-label="<?php esc_attr_e( 'Return to rule list', 'wp-seo-pilot' ); ?>">
				&larr; <?php esc_html_e( 'Back to rules', 'wp-seo-pilot' ); ?>
			</a>
		</div>
	</header>
	...
	<div class="wpseopilot-links__rule-guide">
		<div class="wpseopilot-links__rule-steps">
			<div class="wpseopilot-links__rule-step">
				...
				<div>
					<strong><?php esc_html_e( 'Define the match', 'wp-seo-pilot' ); ?></strong>
					<p><?php esc_html_e( 'Name the rule, choose a category, and list the keywords you want to transform.', 'wp-seo-pilot' ); ?></p>
				</div>
			</div>
			<div class="wpseopilot-links__rule-step">
				<span class="wpseopilot-links__rule-step-number">2</span>
				<div>
					<strong><?php esc_html_e( 'Pick a destination', 'wp-seo-pilot' ); ?></strong>
					<p><?php esc_html_e( 'Link to a post, page, or custom URL and add UTM tracking if needed.', 'wp-seo-pilot' ); ?></p>
				</div>
			</div>
			<div class="wpseopilot-links__rule-step">
				<span class="wpseopilot-links__rule-step-number">3</span>
				<div>
					<strong><?php esc_html_e( 'Control placement', 'wp-seo-pilot' ); ?></strong>
					<p><?php esc_html_e( 'Set limits, choose headings/blocks, scope post types, and preview the output.', 'wp-seo-pilot' ); ?></p>
				</div>
			</div>
		</div>
	</div>
	...
	<form method="post" action="<?php echo esc_url( $form_action ); ?>" class="wpseopilot-links__rule-form" autocomplete="off">
		...
		<section class="wpseopilot-links__section">
			<h3><?php esc_html_e( 'Basics', 'wp-seo-pilot' ); ?></h3>
			<div class="wpseopilot-grid">
				<label>
					<span><?php esc_html_e( 'Internal Title', 'wp-seo-pilot' ); ?></span>
					<input type="text" class="regular-text" name="rule[title]" required value="<?php echo esc_attr( $current_rule['title'] ); ?>" placeholder="<?php esc_attr_e( 'e.g., Services cluster links', 'wp-seo-pilot' ); ?>" />
					<p class="description"><?php esc_html_e( 'Only visible to admins.', 'wp-seo-pilot' ); ?></p>
				</label>
				...
				<label>
					...
					<select name="rule[category]" data-category-select>
						...
						<?php endforeach; ?>
						<option value="__new__">+ <?php esc_html_e( 'New Category…', 'wp-seo-pilot' ); ?></option>
					</select>
					<p class="description"><?php esc_html_e( 'Group rules (e.g., Topic Clusters, Services). Also controls default UTMs and limits if set.', 'wp-seo-pilot' ); ?></p>
				</label>
			</div>

			<div class="wpseopilot-links__new-category" data-new-category hidden>
				<h4><?php esc_html_e( 'Quick category', 'wp-seo-pilot' ); ?></h4>
				<div class="wpseopilot-grid">
					<label>
					...
					<label>
						<span><?php esc_html_e( 'Category cap (per page)', 'wp-seo-pilot' ); ?></span>
		...
		<section class="wpseopilot-links__section">
			<h3><?php esc_html_e( 'Destination', 'wp-seo-pilot' ); ?></h3>
			...
			<div class="wpseopilot-links__destination-field" data-destination-field="post" <?php echo ( 'post' === $destination_type ) ? '' : 'hidden'; ?>>
				...
				<label>
					<span><?php esc_html_e( 'Choose content', 'wp-seo-pilot' ); ?></span>
					<input type="text" data-destination-input placeholder="<?php esc_attr_e( 'Search by title…', 'wp-seo-pilot' ); ?>" value="<?php echo esc_attr( $destination_hint ); ?>" />
				</label>
				<p class="description"><?php esc_html_e( 'Pick one destination per rule.', 'wp-seo-pilot' ); ?></p>
			...
			<div class="wpseopilot-links__destination-field" data-destination-field="url" <?php echo ( 'url' === $destination_type ) ? '' : 'hidden'; ?>>
				<label>
					<span><?php esc_html_e( 'URL', 'wp-seo-pilot' ); ?></span>
		...
		<section class="wpseopilot-links__section">
			<h3><?php esc_html_e( 'Keywords', 'wp-seo-pilot' ); ?></h3>
			<div class="wpseopilot-tag-input" data-tag-input>
				...
				<input type="text" class="wpseopilot-tag-input__field" placeholder="<?php esc_attr_e( 'Type keyword and press Enter', 'wp-seo-pilot' ); ?>" data-tag-input-field />
			</div>
			<p class="description"><?php esc_html_e( 'Use Enter to add each keyword. Exact phrase match; word boundaries recommended.', 'wp-seo-pilot' ); ?></p>
		</section>

		<section class="wpseopilot-links__section">
			<h3><?php esc_html_e( 'UTMs', 'wp-seo-pilot' ); ?></h3>
			<div class="wpseopilot-grid">
				<label>
					<span><?php esc_html_e( 'UTM Template', 'wp-seo-pilot' ); ?></span>
					<select name="rule[utm_template]">
						<option value="inherit" <?php selected( 'inherit', $current_rule['utm_template'] ?? 'inherit' ); ?>><?php esc_html_e( 'Inherit from Category', 'wp-seo-pilot' ); ?></option>
						<?php foreach ( $utm_templates as $template ) : ?>
				...
				<fieldset>
					...
					<p class="description"><?php esc_html_e( 'UTMs are appended for GA tracking. WordPress does not track clicks.', 'wp-seo-pilot' ); ?></p>
				</fieldset>
			</div>
		</section>

		<section class="wpseopilot-links__section">
			<h3><?php esc_html_e( 'Attributes', 'wp-seo-pilot' ); ?></h3>
			<div class="wpseopilot-grid">
				<label>
					<span><?php esc_html_e( 'Link Title', 'wp-seo-pilot' ); ?></span>
		...
		<section class="wpseopilot-links__section">
			...
			<div class="wpseopilot-grid">
				...
				<label class="wpseopilot-links__choice">
					...
					<span><?php esc_html_e( 'Status: Active', 'wp-seo-pilot' ); ?></span>
				</label>
			</div>
			<p class="description"><?php esc_html_e( 'Limit the number of automatic links per page and per block to avoid overlinking.', 'wp-seo-pilot' ); ?></p>
		</section>

		<section class="wpseopilot-links__section">
			<h3><?php esc_html_e( 'Placement', 'wp-seo-pilot' ); ?></h3>
			<div class="wpseopilot-grid">
				<fieldset>
					<legend><?php esc_html_e( 'Apply in headings?', 'wp-seo-pilot' ); ?></legend>
					<label class="wpseopilot-links__choice">
						<input type="radio" name="rule[placement][headings]" value="none" <?php checked( 'none', $heading_behavior ); ?> data-heading-toggle />
						<span><?php esc_html_e( 'None', 'wp-seo-pilot' ); ?></span>
					</label>
					<label class="wpseopilot-links__choice">
						<input type="radio" name="rule[placement][headings]" value="selected" <?php checked( 'selected', $heading_behavior ); ?> data-heading-toggle />
						<span><?php esc_html_e( 'Selected', 'wp-seo-pilot' ); ?></span>
					</label>
					<label class="wpseopilot-links__choice">
						<input type="radio" name="rule[placement][headings]" value="all" <?php checked( 'all', $heading_behavior ); ?> data-heading-toggle />
						<span><?php esc_html_e( 'All', 'wp-seo-pilot' ); ?></span>
					</label>
					<p class="description"><?php esc_html_e( 'Control whether links can appear in headings. For Selected, choose specific levels (H1–H6).', 'wp-seo-pilot' ); ?></p>
		...
		<section class="wpseopilot-links__section">
			<h3><?php esc_html_e( 'Content Scope', 'wp-seo-pilot' ); ?></h3>
			<div class="wpseopilot-grid">
				<label>
					<span><?php esc_html_e( 'Post types', 'wp-seo-pilot' ); ?></span>
				...
				<label>
					<span><?php esc_html_e( 'Whitelist URLs', 'wp-seo-pilot' ); ?></span>
					<textarea name="rule[scope][whitelist]" rows="3" placeholder="https://example.com/services"><?php echo esc_textarea( implode( "\n", $whitelist ) ); ?></textarea>
				</label>
				<label>
					<span><?php esc_html_e( 'Blacklist URLs', 'wp-seo-pilot' ); ?></span>
					<textarea name="rule[scope][blacklist]" rows="3" placeholder="https://example.com/contact"><?php echo esc_textarea( implode( "\n", $blacklist ) ); ?></textarea>
				</label>
			</div>
			<p class="description"><?php esc_html_e( 'Whitelist = only these pages. Blacklist = never these pages.', 'wp-seo-pilot' ); ?></p>
		</section>

		<section class="wpseopilot-links__section">
			<h3><?php esc_html_e( 'Preview / Test', 'wp-seo-pilot' ); ?></h3>
			<p class="description"><?php esc_html_e( 'Preview simulates replacements without saving changes.', 'wp-seo-pilot' ); ?></p>
			<div class="wpseopilot-grid">
				<label>
					<span><?php esc_html_e( 'Select a post', 'wp-seo-pilot' ); ?></span>
					<div class="wpseopilot-links__preview-select" data-preview-target>
						<input type="hidden" data-preview-post />
						<input type="text" data-preview-input placeholder="<?php esc_attr_e( 'Search for content…', 'wp-seo-pilot' ); ?>" />
						<div class="wpseopilot-links__suggestions" data-preview-suggestions hidden></div>
					</div>
				</label>
				<label>
					<span><?php esc_html_e( 'or Enter a URL', 'wp-seo-pilot' ); ?></span>
					<input type="url" data-preview-url placeholder="https://example.com/sample-post" />
				</label>
			</div>
			<button type="button" class="button" data-preview-run><?php esc_html_e( 'Run Preview', 'wp-seo-pilot' ); ?></button>
		...
		<?php submit_button( $is_edit ? __( 'Update rule', 'wp-seo-pilot' ) : __( 'Save rule', 'wp-seo-pilot' ) ); ?>
	</form>
</div>
