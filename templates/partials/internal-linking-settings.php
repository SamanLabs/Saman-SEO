...
<div class="wpseopilot-card">
	<h3><?php esc_html_e( 'Module settings', 'wp-seo-pilot' ); ?></h3>
	<form method="post" action="<?php echo esc_url( $form_action ); ?>" class="wpseopilot-links__settings-form">
		...
		<section>
			<h4><?php esc_html_e( 'Global Defaults', 'wp-seo-pilot' ); ?></h4>
			<div class="wpseopilot-grid">
				<label>
					<span><?php esc_html_e( 'Default max links per page', 'wp-seo-pilot' ); ?></span>
				...
				<fieldset>
					<legend><?php esc_html_e( 'Default heading behavior', 'wp-seo-pilot' ); ?></legend>
					...
					<div class="wpseopilot-links__heading-levels" data-settings-heading <?php echo ( 'selected' === $heading_behavior ) ? '' : 'hidden'; ?>>
