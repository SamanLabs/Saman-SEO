...
?>
<div class="wrap samanlabs-seo-page samanlabs-seo-ai-page">
	...
	<div class="samanlabs-seo-tabs" data-component="samanlabs-seo-tabs">
		<div class="nav-tab-wrapper samanlabs-seo-tabs__nav" role="tablist" aria-label="<?php esc_attr_e( 'AI Assistant sections', 'saman-labs-seo' ); ?>">
			<button
				type="button"
				class="nav-tab nav-tab-active"
				id="samanlabs-seo-tab-link-ai-settings"
				role="tab"
				aria-selected="true"
				aria-controls="samanlabs-seo-tab-ai-settings"
				data-samanlabs-seo-tab="samanlabs-seo-tab-ai-settings"
			>
			...
			<button
				type="button"
				class="nav-tab"
				id="samanlabs-seo-tab-link-custom-models"
				role="tab"
				aria-selected="false"
				aria-controls="samanlabs-seo-tab-custom-models"
				data-samanlabs-seo-tab="samanlabs-seo-tab-custom-models"
			>
		...
		<!-- Settings Tab -->
		<div
			id="samanlabs-seo-tab-ai-settings"
			class="samanlabs-seo-tab-panel is-active"
			role="tabpanel"
			aria-labelledby="samanlabs-seo-tab-link-ai-settings"
		>
			...
			<div class="samanlabs-seo-card">
				...
				<div class="samanlabs-seo-card-body">
					<div class="samanlabs-seo-card-toolbar">
			...
			<div class="samanlabs-seo-card">
				...
				<div class="samanlabs-seo-card-body">
					...
					<div class="samanlabs-seo-features-grid">
						<div class="samanlabs-seo-feature">
							...
							<ul class="samanlabs-seo-feature-list">
		...
		<!-- Custom Models Tab -->
		<div
			id="samanlabs-seo-tab-custom-models"
			class="samanlabs-seo-tab-panel"
			role="tabpanel"
			aria-labelledby="samanlabs-seo-tab-link-custom-models"
		>
			<div class="samanlabs-seo-card">
				<div class="samanlabs-seo-card-header">
				...
				<div class="samanlabs-seo-card-body">
					<div class="samanlabs-seo-coming-soon">
						<div class="samanlabs-seo-coming-soon-icon">
						...
						<div class="samanlabs-seo-coming-soon-features">
						...
						<div class="samanlabs-seo-coming-soon-cta">
